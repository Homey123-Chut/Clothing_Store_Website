...
const products = [
  { id: 1, name: "Slim Fit Jeans", originalPrice: 59.99, salePrice: 17.99, discount: 70, image: Men_jean1, colors: ['blue'] },
  { id: 2, name: "Straight Fit Jeans", originalPrice: 64.99, salePrice: 19.49, discount: 70, image: Men_jean2, colors: ['black'] },
  { id: 3, name: "Tapered Fit Jeans", originalPrice: 69.99, salePrice: 20.99, discount: 70, image: Men_jean3, colors: ['grey'] },
  { id: 4, name: "Regular Fit Jeans", originalPrice: 55.99, salePrice: 16.79, discount: 70, image: Men_jean4, colors: ['dark blue'] },
  { id: 5, name: "Relaxed Fit Jeans", originalPrice: 60.99, salePrice: 18.29, discount: 70, image: Men_jean5, colors: ['light blue'] },
  { id: 6, name: "Skinny Fit Jeans", originalPrice: 62.99, salePrice: 18.89, discount: 70, image: Men_jean6, colors: ['blue', 'black'] },
  { id: 7, name: "Distressed Jeans", originalPrice: 66.99, salePrice: 20.09, discount: 70, image: Men_jean7, colors: ['ripped blue'] },
  { id: 8, name: "Cropped Jeans", originalPrice: 58.99, salePrice: 17.69, discount: 70, image: Men_jean8, colors: ['blue'] },
  { id: 9, name: "Bootcut Jeans", originalPrice: 61.99, salePrice: 18.59, discount: 70, image: Men_jean9, colors: ['dark grey'] },
  { id: 10, name: "Baggy Fit Jeans", originalPrice: 67.99, salePrice: 20.39, discount: 70, image: Men_jean10, colors: ['blue', 'grey'] },
];

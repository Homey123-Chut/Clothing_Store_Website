...
const products = [
  { id: 1, name: "Classic Analog Watch", originalPrice: 149.99, salePrice: 29.99, discount: 80, image: accessories_watches1, colors: ['black', 'silver'] },
  { id: 2, name: "Digital Sports Watch", originalPrice: 129.99, salePrice: 25.99, discount: 80, image: accessories_watches2, colors: ['blue', 'grey'] },
  { id: 3, name: "Luxury Leather Strap Watch", originalPrice: 199.99, salePrice: 39.99, discount: 80, image: accessories_watches3, colors: ['brown', 'gold'] },
  { id: 4, name: "Minimalist Quartz Watch", originalPrice: 139.99, salePrice: 27.99, discount: 80, image: accessories_watches4, colors: ['white', 'rose gold'] },
  { id: 5, name: "Smart Fitness Watch", originalPrice: 179.99, salePrice: 35.99, discount: 80, image: accessories_watches5, colors: ['black', 'green'] },
  { id: 6, name: "Elegant Dress Watch", originalPrice: 159.99, salePrice: 31.99, discount: 80, image: accessories_watches6, colors: ['silver', 'navy'] }
];

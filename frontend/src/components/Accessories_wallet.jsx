...
const products = [
  { id: 1, name: "Leather Bifold Wallet", originalPrice: 49.99, salePrice: 9.99, discount: 80, image: accessories_wallet1, colors: ['brown', 'black'] },
  { id: 2, name: "Minimalist Card Holder", originalPrice: 29.99, salePrice: 5.99, discount: 80, image: accessories_wallet2, colors: ['navy', 'grey'] },
  { id: 3, name: "Zip-Around Wallet", originalPrice: 59.99, salePrice: 11.99, discount: 80, image: accessories_wallet3, colors: ['red', 'black'] },
  { id: 4, name: "Travel Wallet Organizer", originalPrice: 64.99, salePrice: 12.99, discount: 80, image: accessories_wallet4, colors: ['blue', 'brown'] },
  { id: 5, name: "Classic Trifold Wallet", originalPrice: 39.99, salePrice: 7.99, discount: 80, image: accessories_wallet5, colors: ['black'] },
  { id: 6, name: "RFID Blocking Wallet", originalPrice: 54.99, salePrice: 10.99, discount: 80, image: accessories_wallet6, colors: ['grey', 'green'] },
  { id: 7, name: "Coin Pocket Wallet", originalPrice: 34.99, salePrice: 6.99, discount: 80, image: accessories_wallet7, colors: ['brown'] },
  { id: 8, name: "Slim Business Wallet", originalPrice: 44.99, salePrice: 8.99, discount: 80, image: accessories_wallet8, colors: ['black', 'tan'] }
];
